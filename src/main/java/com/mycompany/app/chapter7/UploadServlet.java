package com.mycompany.app.chapter7;
...
public class UploadServlet extends HttpServlet {
	...
	private void loadCascade() {
		String cascadePath = getResourcePath("/chapter07res/cascades/lbpcascade_frontalface.xml");
	...
	private Mat loadOverlayImage() {
		String overlayFileName = getResourcePath("/chapter07res/images/fedora.png");
